        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="mt-1 text-2xl font-semibold">Begin Scenario</h1>
            </div>
          </div>

          <p className="mt-4 text-sm text-white/60">
            A new incarnation has entered the Star Stream. Your constellation
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            >
              {loading ? "Initiating..." : "Begin Scenario"}
            </button>
          </form>
